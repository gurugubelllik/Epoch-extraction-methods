function [res] = Get_MaxLP_Residual(s,fs,order)
...
%%
% References
% [1] T.Drugman, "Maximum Phase Modeling for Sparse Linear
% Prediction of Speech", IEEE Signal Processing Letters, vol. 21, issue 2,
% pp. 185-189, 2014.
%
